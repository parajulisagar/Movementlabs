...
export declare const USDC_IMX_TESTNET: Token;
export declare const USDC_IMX_MAINNET: Token;
export declare const USDC_MOVEMENT_TESTNET: Token;
export declare const USDC_GLUE_TESTNET: Token;
