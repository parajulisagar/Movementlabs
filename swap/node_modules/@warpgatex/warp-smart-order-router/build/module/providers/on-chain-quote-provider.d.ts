 ...
 */
export declare type RouteWithQuotes<TRoute extends V3Route> = [
    TRoute,
    AmountQuote[]
];
/**
...
export interface IOnChainQuoteProvider {
     ...
     */
    getQuotesManyExactIn<TRoute extends V3Route>(amountIns: CurrencyAmount[], routes: TRoute[], providerConfig?: ProviderConfig): Promise<{
...
export declare class OnChainQuoteProvider implements IOnChainQuoteProvider {
     ...
     */
    protected validateRoutes(routes: (V3Route)[], functionName: string, useMixedRouteQuoter: boolean): void;
}
