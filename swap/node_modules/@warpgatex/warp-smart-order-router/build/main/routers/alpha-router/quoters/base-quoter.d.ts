...
import { ChainId, Currency, Token, TradeType } from '@warpgatex/warp-sdk-core';
 ...
 * @template Route
 */
export declare abstract class BaseQuoter<CandidatePools extends V3CandidatePools | [V3CandidatePools], Route extends V3Route> {
    ...
    protected applyTokenValidatorToPools<T extends Pool>(pools: T[], isInvalidFn: (token: Currency, tokenValidation: TokenValidationResult | undefined) => boolean): Promise<T[]>;
}
