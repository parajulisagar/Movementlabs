...
var Pool = /*#__PURE__*/function () {
  ...
  _proto.nonImpactfulHook = function nonImpactfulHook() {
...
var Route = /*#__PURE__*/function () {
  ...
  function Route(pools, input, output) {
    ...
    !pools[0].involvesCurrency(input) ?  invariant(false, 'INPUT')  : void 0;
    !pools[pools.length - 1].involvesCurrency(output) ?  invariant(false, 'OUTPUT')  : void 0;
    /**
     * Normalizes currency0-currency1 order and selects the next currency/fee step to add to the path
     * */
    var currencyPath = [input];
...
var Trade = /*#__PURE__*/function () {
  ...
  function () {
    var _fromRoute = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(route, amount, tradeType) {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            amounts = new Array(route.currencyPath.length);
            ...
            i = 0;
          case 5:
            if (!(i < route.currencyPath.length - 1)) {
              _context3.next = 15;
              break;
            }
            pool = route.pools[i];
          ...
          case 19:
            ...
            _i = route.currencyPath.length - 1;
          case 22:
            if (!(_i > 0)) {
              _context3.next = 32;
              break;
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          ...
          case 2:
            ...
            !amount.currency.equals(route.input) ?  invariant(false, 'INPUT')  : void 0;
            inputAmount = sdkCore.CurrencyAmount.fromFractionalAmount(route.input, amount.numerator, amount.denominator);
            amounts[0] = sdkCore.CurrencyAmount.fromFractionalAmount(route.input, amount.numerator, amount.denominator);
            i = 0;
          case 12:
            if (!(i < route.currencyPath.length - 1)) {
              _context4.next = 22;
          ...
          case 25:
            !amount.currency.equals(route.output) ?  invariant(false, 'OUTPUT')  : void 0;
            outputAmount = sdkCore.CurrencyAmount.fromFractionalAmount(route.output, amount.numerator, amount.denominator);
            amounts[amounts.length - 1] = sdkCore.CurrencyAmount.fromFractionalAmount(route.output, amount.numerator, amount.denominator);
            _i2 = route.currencyPath.length - 1;
          case 29:
            if (!(_i2 > 0)) {
              _context4.next = 39;
              break;
  ...
  function () {
    ...
    currentPools, nextAmountIn, bestTrades) {
      var _ref5, _ref5$maxNumResults, maxNumResults, _ref5$maxHops, maxHops, amountIn, i, pool, amountOut, _yield$pool$getOutput3, poolsExcludingThisPool;
  ...
  function () {
    ...
    currentPools, nextAmountOut, bestTrades) {
      var _ref6, _ref6$maxNumResults, maxNumResults, _ref6$maxHops, maxHops, amountOut, i, pool, amountIn, _yield$pool$getInputA, poolsExcludingThisPool;
